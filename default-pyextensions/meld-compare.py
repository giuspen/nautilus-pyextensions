...
class MeldActions(GObject.GObject, Nemo.MenuProvider):
    """Implements the 'Meld Compare' extension to the Nemo right-click menu"""
    ...
    def get_file_items(self, window, sel_items):
        ...
        if num_paths == 2:
            ...
            item = Nemo.MenuItem(name='Meld::meld',
        ...
        if os.path.isfile(element_1) and not self._is_text_document(element_1):
            return
        # top menuitem
        top_menuitem = Nemo.MenuItem(name='Meld::actions',
        ...
        # submenu items save
        sub_menuitem_save = Nemo.MenuItem(name='Meld::save',
        ...
        if stored_path and stored_path != element_1 and ( (os.path.isfile(stored_path) and os.path.isfile(element_1) ) or (os.path.isdir(stored_path) and os.path.isdir(element_1) ) ):
            sub_menuitem_compare_saved = Nemo.MenuItem(name='Meld::compare_saved',
